            ...
            <table class="table table-bordered table-striped tbl-master" id="report-table">
                ...
                <?php foreach($report_data as $row){?>
                    <tr>
                        ...
                        <td class="dt-right"><?php echo $row['Rating'] != "" ? $row['Rating']: 0 ;?></td>
                        <td class="dt-center">
                            <a href="<?php echo site_url()."/Report/reportClinicPoliVisitDetail/".$row['clinicID']."/".$row['poliID']."/".$start_date."/".$end_date;?>">
...
<script>
    $(function() {
        ...
        $('#btn-search').click(function(){
            ...
            var $url = "<?php echo site_url();?>"+"/Report/reportClinicPoliRating?";
            $url+="from="+$start;
            $url+="&to="+$end;
