...
<script>
    $(function() {
        ...
        var table = $('#dataTables-list').DataTable({
            ...
            "ajax": {
                "url": baseurl+"SettingSchedule/dataScheduleListAjax/"+<?php echo $superUserID;?>,
                "type": "POST"
            },
        ...
        $( "#dataTables-list tbody" ).on( "click", "button.edit-btn", function() {
            ...
            var super_user_Id = "<?php echo $superUserID;?>";

            location.href = baseurl+"SettingSchedule/goToSettingDetailSchedule/"+clinic+"/"+poli+"/"+super_user_Id;
        });
    });
</script>