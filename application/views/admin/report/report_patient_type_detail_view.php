...
<section class="content-header">
    <h1>
        Detil Laporan Kunjungan Umum/BPJS
...
<section class="content">
    <p>
        <div class="row">
            <div class="col-lg-8">
                <a href="<?php echo site_url()."/Report/reportPatientType/".$super_admin_id."?from=".$start_date."&to=".$end_date;?>">
    ...
    <div class="box" id="content-container" >
        <div class="box-header with-border">
            <h3 class="box-title"><?php echo $clinic_name;?></h3>
        </div>
        <div class="box-body">
    ...
    $(function() {
        ...
        $('#btn-filter-search').click(function(){
            ...
            */
            ...
            if($poli != "" ){
                $dataTable.columns(3).search($poli).draw();
            }else{
