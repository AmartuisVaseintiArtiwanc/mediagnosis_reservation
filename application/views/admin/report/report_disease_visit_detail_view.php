...
<section class="content-header">
    <h1>
        Detil Laporan Kunjungan Sehat/Sakit
...
<section class="content">
    <p>
        <div class="row">
            <div class="col-lg-8">
                <a href="<?php echo site_url()."/Report/reportDiseaseVisit/".$super_admin_id."?from=".$start_date."&to=".$end_date;?>">
    ...
    <div class="box box-primary box-hide" id="filter-box">
        ...
        <div class="box-body">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="poli-filter">Klinik</label>
                        <input type="text" class="form-control" id="clinic-filter" placeholder="Klinik">
                    </div>
                    <div class="form-group">
                        <label for="poli-filter">Poli</label>
                        <input type="text" class="form-control" id="poli-filter" placeholder="Poli">
                    </div>
                    <div class="form-group">
    ...
    <div class="box" id="content-container" >
        <div class="box-header with-border">
            <h3 class="box-title"><?php echo $disease_name;?></h3>
        </div>
        <div class="box-body">
...
<script>
    $(function() {
        ...
        $('#btn-filter-search').click(function(){
            ...
            var $poli = $('#poli-filter').val();
            var $clinic = $('#clinic-filter').val();
            ...
            */
            if($clinic != "" ){
                $dataTable.columns(3).search($clinic).draw();
            }else{
                $dataTable.columns(3).search("").draw();
            }
            if($poli != "" ){
                $dataTable.columns(4).search($poli).draw();
            }else{
                $dataTable.columns(4).search("").draw();
            }

            if($visit_type != "" ){
                $dataTable.columns(5).search($visit_type).draw();
            }else{
                $dataTable.columns(5).search("").draw();
            }

            if($reserve_type != "" ){
                $dataTable.columns(6).search($reserve_type).draw();
            }else{
                $visit_type.columns(6).search("").draw();
            }
        });
