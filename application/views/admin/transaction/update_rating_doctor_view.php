            ...
            <div class="row">
                <div class="col-lg-8">
                    <button type="button" class="btn btn-primary btn-xl" id="btn-update-doctor">
                        <span class="glyphicon glyphicon-open"></span>&nbsp Update Rating Dokter
                    </button>
                </div>
            </div>
            </p>
...
<script>
    $(function() {
        ...
        var table = $('#dataTables-list').DataTable({
            ...
            "ajax": {
                "url": $base_url+"Rating/dataRatingDoctorListAjax",
                "type": "POST"
            },
        ...
        $('#btn-update-doctor').click(function () {
            ...
            alertify.confirm("Apakah Anda yakin untuk Meng-Update Rating Dokter ?",function(){
                $.ajax({
                    ...
                    success:function(data){
                        if(data.status != "error"){
                            ...
                            window.setTimeout( function(){
                                ...
                                location.href = $base_url+"Rating/ratingDoctorList";
                            }, 1500 );
                        }else{
